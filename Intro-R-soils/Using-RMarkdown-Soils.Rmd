...
## Let's talk about how to structure an RMarkdown file

* Name, title and description at the top
* First code chunk reads in all the library statements and the data (keep it all together here!)
* Each chunk represents one "unit" of code, or some significant task. There should be lots of chunks in your file, this is the strength of an RMarkdown file!
* Make good use of text, notes, and headers in the whitespace between the chunks
* Knit often to make sure things work and that your code is free of bugs
* Don't get too worried if you get an error - you can't break R!
...
```{r soil_data}
soil_data <- read.csv("https://raw.githubusercontent.com/mlammens/BEDE-Network-Workshop-Materials/main/Intro-R-soils/soil_nutrient_data.csv")
```
